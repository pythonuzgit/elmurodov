...
3. **PyTorch: Image Classification using PyTorch_with paddy_pests dataset** [Example](https://github.com/pythonuzgit/elmurodov/blob/master/Image_classification_using_PyTorch_with_paddy_pests_dataset.ipynb)
