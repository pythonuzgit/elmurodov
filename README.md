...
2. **PyTorch: Image Classification model using PyTorch with applescablds**  [Example](https://github.com/pythonuzgit/elmurodov/blob/master/Image_Classification_using_PyTorch_with_applescablds.ipynb)
